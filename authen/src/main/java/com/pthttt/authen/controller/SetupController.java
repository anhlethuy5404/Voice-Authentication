...
public class SetupController {
    ...
    public String trainModel(
        ...
        int newVerison = setupService.findMaxVersionByModelId(modelId) + 1;
        ...
        Map<String, Object> dataset = setupService.prepareDataset(parsedVoices, splitTrain, splitVal, modelType);
        ...
        try {
            ...
            setupService.startTrainingAsync(pythonWsUrl, jsonConfig, new SetupService.TrainingListener() {
                @Override
    ...
    public Map<String, Object> saveTrainingResult(@RequestBody Map<String, Object> data) {
        try {
            ...
            String result = setupService.saveTrainingResult(data);
